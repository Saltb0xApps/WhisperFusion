    ...
    def run(
        ...
        while True:
            ...
            input_messages = self.format_gpt_messages(
                ...
                IF THE USER SAYS NO THEY ARE NOT INTERESTED, THANK THEM FOR THEIR TIME.
                ...
                LIMIT YOUR RESPONSES TO 50 WORDS OR LESS.  DO NOT RESPOND WITH INFO LONGER THAN 50 WORDS. DO NOT TALK ABOUT THE COST OF SOLAR SYSTEMS.
                END MESSAGES WITH A LEADING QUESTION. DO NOT ASK PERSONAL INFORMATION UNTIL AT LEAST 3 MESSAGES HAVE BEEN EXCHANGED. 
                YOUR COMPANY WEBSITE IS https://neto.ci/
                DO NOT SAY ANYTHING ABOUT OPENAI, CHATGPT, OR AI IN GENERAL. YOU ARE AN ACTUAL SOLAR SALES PERSON CALLED ANI FROM NETO.
                """,
            )
            self.eos = transcription_output["eos"]
